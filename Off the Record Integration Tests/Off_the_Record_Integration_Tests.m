...
- (void)test_FacebookAccount {
    ...
    facebookAccount.username = @"chatterboxapps@gmail.org";
...
- (void)test_XMPPAccounts
{
    ...
    NSDictionary * accountCredentials = @{@"chatterbox@jabber.me":jabbermePassword,
                                          @"test_chatterbox@jabber.ccc.de":jabberCccPassword,
                                          @"test_chatterbox@jabber.systemli.org":systemliPassword};
