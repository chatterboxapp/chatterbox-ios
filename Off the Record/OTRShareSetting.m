...
- (NSString*) shareString {
    return [NSString stringWithFormat:@"%@. Download Chatterbox on Cydia today.", SHARE_MESSAGE_STRING];
}

- (NSString*) twitterShareString {
    return [NSString stringWithFormat:@"%@ #chatterboxapp", [self shareString]];
}
