...
- (void) setupImageView {
    self.imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"chatterbox_banner.png"]];
...
- (void)viewDidLoad
{
    ...
    OTRAboutTableCellData *homepageData = [OTRAboutTableCellData cellDataWithTitle:PROJECT_HOMEPAGE_STRING url:[NSURL URLWithString:@"https://github.com/chatterboxapp/chatterbox-ios"]];
    OTRAboutTableCellData *sourceData = [OTRAboutTableCellData cellDataWithTitle:SOURCE_STRING url:[NSURL URLWithString:@"https://github.com/chatterboxapp/chatterbox-ios"]];
    OTRAboutTableCellData *translateData = [OTRAboutTableCellData cellDataWithTitle:CONTRIBUTE_TRANSLATION_STRING url:[NSURL URLWithString:@"https://www.transifex.com/projects/p/chatterboxapp"]];
