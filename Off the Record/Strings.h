...
#define LANGUAGE_ALERT_MESSAGE_STRING [OTRLanguageManager translatedString: @"In order to change languages return to the home screen and remove Chatterbox from the recently used apps"]
...
#define QR_CODE_INSTRUCTIONS_STRING [OTRLanguageManager translatedString: @"This QR Code contains a link to http://omniqrcode.com/q/chatterbox and will redirect to the App Store."]
...
#define DONATE_MESSAGE_STRING [OTRLanguageManager translatedString: @"Your donation will help fund the continued development of Chatterbox."]
