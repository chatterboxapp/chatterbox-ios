...
+ (void) copyTestDatabaseToDestination:(NSURL*)destinationURL {
    NSURL *testDBURL = [[NSBundle mainBundle] URLForResource:@"Chatterbox" withExtension:@"sqlite"];
...
+ (BOOL) setupDatabaseWithName:(NSString*)databaseName {
    ...
    NSURL *mom2 = [[NSBundle mainBundle] URLForResource:@"Chatterbox 2" withExtension:@"mom" subdirectory:@"Chatterbox.momd"];
    NSURL *mom3 = [[NSBundle mainBundle] URLForResource:@"Chatterbox 3" withExtension:@"mom" subdirectory:@"Chatterbox.momd"];
    ...
    [MagicalRecord setDefaultModelNamed:@"Chatterbox.momd"];
...
+ (BOOL)migrateLegacyStore:(NSURL *)storeURL destinationStore:(NSURL*)destinationURL {
    NSURL *mom1 = [[NSBundle mainBundle] URLForResource:@"Chatterbox" withExtension:@"mom" subdirectory:@"Chatterbox.momd"];
    NSURL *mom2 = [[NSBundle mainBundle] URLForResource:@"Chatterbox 2" withExtension:@"mom" subdirectory:@"Chatterbox.momd"];
